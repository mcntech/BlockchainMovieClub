...
const privateKey = Buffer.from(
  'a26ecf489e39d27a26cc2b1ba7cd8a6ef0256b3e8038fecd07f2a7d0d8983c82',
  'hex',
); // test key
const publicKey = Buffer.from(
  '47160d1b68c4c21974c9fb96428d8213f48418c9',
  'hex',
);
...
class Advertiser extends Component {
  constructor(props) {
    ...
    this.handleChangeAdvertiserAccount = this.handleChangeAdvertiserAccount.bind(
      this,
    );
    this.handleSubmitAdvertiserAccount = this.handleSubmitAdvertiserAccount.bind(
      this,
    );
  ...
  handleSubmitMovieAddr(event) {
    const movieAddr = Buffer.from(
      '86972749aedd94711edc884a6a0c4bb78abc9612',
      'hex',
    );
    console.log(bcmc.abi[9]);
    const codedCall = coder.encodeFunctionCall(bcmc.abi[9], [
      `0x${movieAddr.toString('hex')}`,
    ]);
  ...
  handleSubmitAdvertiserAccountDeferred(account_nonce) {
    ...
    const codedCall = coder.encodeFunctionCall(bcmc.abi[2], [
          ...
          <form onSubmit={this.handleSubmitMovieMakerAccount}>
            ...
            <div className={s.formGroup}>
              <label className={s.label} htmlFor="url">
                ...
                />
                <br />
                (Example: http://myfilm.myserver.com)
              </label>
            </div>
            <div className={s.formGroup}>
